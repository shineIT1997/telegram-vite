...
export async function init(
  ...
  client = new TelegramClient(
    session,
    import.meta.env.TELEGRAM_T_API_ID,
    import.meta.env.TELEGRAM_T_API_HASH,
    {
...
export function downloadMedia(
  ...
  return downloadMediaWithClient(args, client, isConnected, onProgress).catch(
    async (err) => {
